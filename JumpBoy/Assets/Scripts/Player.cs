...
namespace Assets.Scripts
{
    public class Player
    {
        public Player(int coinValue, int speedLevel,   float jumpForce, bool isJumping, bool isFacingRight,  Rigidbody2D rigidbody2D, BoxCollider2D boxCollider2D)
        {
            CoinValue = coinValue;
        ...
        private int speedLevel { get; set; }

        private int jumpLevel { get; set; }
